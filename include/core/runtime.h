...
extern const char context_t_name[];
using context_t = builder::name<context_t_name>;
...
extern builder::dyn_var<int(context_t *, char *, int)> send_packet_ctx;
...
extern builder::dyn_var<void(timer_t *, unsigned long long, void *, void *)>
    insert_timer;
extern builder::dyn_var<void(timer_t *)> remove_timer;

// Context-based timer functions
extern builder::dyn_var<timer_t *(context_t *)> alloc_timer_ctx;
extern builder::dyn_var<void(context_t *, timer_t *)> return_timer_ctx;
extern builder::dyn_var<void(context_t *, timer_t *, unsigned long long, void *,
                             void *)>
    insert_timer_ctx;
extern builder::dyn_var<void(context_t *, timer_t *)> remove_timer_ctx;
extern builder::dyn_var<context_t *(timer_t *)> get_timer_context;
...
extern builder::dyn_var<unsigned long long(unsigned int, rte_t *, int)>
