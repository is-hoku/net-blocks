...
public:
  ...
  module::hook_status hook_establish_ctx(
  ...
  module::hook_status hook_send_ctx(builder::dyn_var<runtime::context_t *> ctx,
                                    ...
                                    packet_t p, builder::dyn_var<char *> buff,
                                    builder::dyn_var<unsigned int> len,
                                    builder::dyn_var<int *> ret_len);
  module::hook_status
  hook_ingress_ctx(builder::dyn_var<runtime::context_t *> ctx, packet_t);

  void configEnableRouting(void) { is_enabled = true; }
  void configDisableRouting() { is_enabled = false; }
