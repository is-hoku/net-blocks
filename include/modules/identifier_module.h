...
public:
  ...
  void configFlowIdentifier(flow_identifier_t f) { flow_identifier = f; }
  ...
  hook_destablish_ctx(builder::dyn_var<runtime::context_t *> ctx,
                      builder::dyn_var<connection_t *> c) override;
  ...
  void hook_net_init_ctx(builder::dyn_var<runtime::context_t *> ctx) override;

private:
  // Internal functions
  void add_connection(builder::dyn_var<connection_t *> c,
  ...
  retrieve_connection(builder::dyn_var<unsigned int> appid,
                      builder::dyn_var<unsigned int> src_app_id,
                      builder::dyn_var<unsigned long long> src_host_id);
  ...
  builder::dyn_var<connection_t *>
  retrieve_wildcard_connection(builder::dyn_var<unsigned int> appid);
